      ...
      <div class="loginInner">
        <div class="login_header">
          ...
          <div class="login_header_title">
            <a href="javascript:;" :class="{on:loginWay}" name='duanxin' @click="loginWay=true">短信登录</a>
            <a href="javascript:;" name="pwd" :class="{on:!loginWay}" @click="loginWay=false">密码登录</a>
          </div>
        </div>
        <div class="login_content">
          <form>
            ...
            <div :class="{on:!loginWay}">
              <section>
                <section class="login_message">
                  <input type="tel" maxlength="11" placeholder="手机/邮箱/用户名" v-model="name" name="name" v-validate="'required|name'">
                  <span style="color: red;" v-show="errors.has('name')">{{ errors.first('name') }}</span>
                </section>
                <section class="login_verification">
                  <input :type="isShowpwd? 'text': 'password'" maxlength="8" placeholder="请输入密码" v-model="pwd" name="pwd" v-validate="'required|pwd'">
